...
VEGGIE_IMG = {
    ...
    "さといも":           ("satoimo",      "#efebe9"),
    "さやえんどう":       ("sayaendo",     "#dcedc8"),
    "しゅんぎく":         ("shungiku",     "#e8f5e9"),
    "じゃがいも":         ("potato",       "#f5f5dc"),
    "そらまめ":           ("soramame",     "#c8e6c9"),
    "たけのこ":           ("takenoko",     "#fff9c4"),
    "たまねぎ":           ("onion",        "#ffe0b2"),
    "だいこん":           ("daikon",       "#f0f0f0"),
    "とうもろこし":       ("corn",         "#fffde7"),
    "なす":               ("eggplant",     "#e1bee7"),
    "なのはな":           ("nanohana",     "#fff9c4"),
    "なましいたけ":       ("shiitake",     "#efebe9"),
    "にら":               ("nira",         "#e8f5e9"),
    "にんじん":           ("carrot",       "#ffe0b2"),
    "ねぎ":               ("negi",         "#f9fbe7"),
    "はくさい":           ("hakusai",      "#e8f5e9"),
    ...
    "まつたけ":           ("matsutake",    "#efebe9"),
    "みずな":             ("mizuna",       "#e8f5e9"),
    "れんこん":           ("renkon",       "#fce4ec"),
    "アスパラガス":       ("asparagus",    "#dcedc8"),
    "オクラ":             ("okra",         "#c8e6c9"),
    "キャベツ":           ("cabbage",      "#d4edda"),
    "スナップ実えんどう": ("snapendo",     "#dcedc8"),
    "セルリー":           ("celery",       "#ccff90"),
    "トマト":             ("tomato",       "#ffcdd2"),
    "ピーマン":           ("pepper",       "#c5e1a5"),
    "ブロッコリー":       ("broccoli",     "#aed581"),
    "ミニトマト":         ("minitomato",   "#ffcdd2"),
    "レイシ":             ("lychee",       "#fce4ec"),
    "レイシにがうり":     ("goya",         "#c8e6c9"),
    "レタス":             ("lettuce",      "#c8e6c9"),
}
